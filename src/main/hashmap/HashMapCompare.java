...
public class HashMapCompare {
    public static void main(String[] args) {
        ...
        //1. onn the basis of key-value: used equals method
        ...
        //combine key form the both maps: using HashSet
        ...
        //1. duplicate are not allowed : using ArrayList
        ...
        //2. duplicate are allowed : using ArrayList
    ...
    public static class rverseString {
        public static void main(String[] args) {
